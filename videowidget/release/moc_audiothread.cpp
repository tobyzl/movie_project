...
QT_MOC_LITERAL(2, 28, 0) // ""
    ...
    "AudioThread\0sig_GetOneFrame\0"
};
...
void AudioThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (AudioThread::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioThread::sig_GetOneFrame)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioThread::sig_GetOneFrame(QImage _t1)
{
